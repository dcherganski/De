...
|---|---:|
| Сигнал „ИЗЧАКАЙ“ | 38 |
| Сигнал „ПРОДАЙ“ (в long-only режим: излез от позиция) | 14 – XRP, DOGE, XLM, TAO, PEPE, ICP, DASH, DOT, APT, GFI, SEI, VET, STX, FLR |
| Сигнал „КУПИ“ | 2 – HYPE, SKY |
| Вероятност за ръст под 50% | 48 |
| Отбелязани с „предимство в бектеста“ (Brier skill > 0 и AUC > 0,5) | 17 |
...
- **Посоката остава на нивото на монетата.** Медианният AUC на ансамбъла е 0,495
  ...
  случай. Предпазителят е свободен: при 54 теста около една трета минават прага и по
  случайност. При HYPE „предимството“ идва само от 31 прогнози, при GFI AUC е 0,502 –
  моделът не различава дните, а само е научил, че монетата пада.
...
- **Стратегиите „бият“ купи-и-дръж най-вече като стоят в кеш.** При 17-те актива с
  предимство стратегията е в позиция 1–48% от времето. 11 от тях са на печалба, а 6 са на
  загуба, въпреки предимството (TAO, PEPE, APT, SEI, SKY, HYPE).
